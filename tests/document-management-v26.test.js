...
assert(html.includes('Gestão de Documentos')&&lazy.includes('document-management-v26.js')&&lazy.includes('document-management-v26.css'),'V26 deve estar ligada ao carregador modular');
assert(sw.includes('vg-operations-shell-v35-7')&&!sw.includes('/assets/js/modules/document-management-v26.js'),'Documentos deve carregar por necessidade em V35.7');
