...
assert(html.includes('Agenda Operacional')&&lazy.includes('operational-agenda-v22.js')&&lazy.includes('operational-agenda-v22.css'),'V22 deve estar ligada à Agenda por carregamento modular');
assert(sw.includes('vg-operations-shell-v35-7')&&!sw.includes('/assets/js/modules/operational-agenda-v22.js'),'Agenda deve ficar fora do pre-cache inicial em V35.7');
