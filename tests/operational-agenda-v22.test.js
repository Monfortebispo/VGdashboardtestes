...
assert(sw.includes('vg-operations-shell-v31')&&sw.includes('/assets/js/modules/operational-agenda-v22.js')&&sw.includes('/assets/css/operational-agenda-v22.css'),'PWA deve incluir shell estático da Agenda V22');
