...
assert(js.includes('ensureIntegratedData')&&js.includes("if(currentView==='housekeeping'){renderHK();return;}"),'seed pesado deve carregar apenas ao abrir Reputação/Receita/A&B; Housekeeping exato não depende dele');
