...
assert(model.includes('interface PurchasesTheoryPayload'),'deve existir payload tipado do consumo teórico');
...
assert(source.includes('theoretical:{matched:matched.length'),'snapshot deve contar vendas com ficha');
assert(source.includes('theoreticalData:{matched,unmatched,ingredients}'),'snapshot deve transportar os dados necessários ao renderer moderno');
