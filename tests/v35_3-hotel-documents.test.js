...
assert.strictEqual(pkg.version,'35.7.0');
assert(html.includes('content="35.7"')&&html.includes('V35.7 · Performance'),'HTML e badge devem identificar V35.7');
assert(sw.includes("const CACHE_NAME = 'vg-operations-shell-v35-7'"),'Service Worker deve usar cache V35.7');
