...
assert(guard.includes("const BUILD='30.0'"),'build guard mantém identificador estável e updateViaCache:none');
assert(sw.includes("vg-operations-shell-v30_3"),'service worker deve usar cache V30.3');
