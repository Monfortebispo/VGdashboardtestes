...
assert(sw.includes("vg-operations-shell-v27")&&sw.includes('/assets/js/ui/notifications-v21.js')&&sw.includes('/assets/css/notifications-v21.css'),'PWA deve pré-cachear apenas a interface estática V21');
