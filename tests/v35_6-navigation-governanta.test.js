...
assert(html.includes('content="35.7"')&&html.includes('V35.7 · Performance'),'HTML deve identificar V35.7');
assert(guard.includes("PLATFORM_BUILD='35.7'"),'Version Guard deve identificar V35.7');
assert(sw.includes("vg-operations-shell-v35-7"),'Service Worker deve usar cache V35.7');
...
console.log('✓ V35.7: Hotel 360 Eficiência, Ctrl+K, Governanta direta e CSS 125% validados');
