...
assert(js.includes("serviceWorker.register(window.__VG_SW_URL__||'/service-worker.js?vg=30.0'"),'cliente deve registar service worker versionado');
...
assert(sw.includes('vg-operations-shell-v30'),'service worker deve usar cache versionada v30');
