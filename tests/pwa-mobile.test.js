...
assert(sw.includes('vg-operations-shell-v35-7'),'service worker deve usar cache versionada V35.7');
assert(!sw.includes('/assets/js/modules/audit-governance.js')&&!sw.includes('/assets/css/audit-governance.css'),'V35.7 deve carregar Governação apenas quando aberta');
assert(!sw.includes('/assets/js/modules/backup-recovery.js')&&!sw.includes('/assets/css/backup-recovery.css'),'V35.7 deve carregar Backup apenas quando aberto');
