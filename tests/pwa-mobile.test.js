...
assert(js.includes("serviceWorker.register(window.__VG_SW_URL__||'/service-worker.js?vg=31.1'"),'cliente deve registar service worker versionado');
...
assert(sw.includes('vg-operations-shell-v31'),'service worker deve usar cache versionada v30');
