...
const pkg=require('../package.json'),html=read('index.html'),auth=read('assets/js/auth/auth-client.js'),server=read('netlify/functions/dashboard-sessao.js'),hkjs=read('assets/js/modules/housekeeping-native-v35.js'),nav=read('assets/js/ui/navigation-shell.js'),search=read('assets/js/ui/global-search.js');
assert.strictEqual(pkg.version,'35.4.0','V35.4 deve estar identificada no package');
...
(async()=>{
  ...
  console.log('✓ V35.4: Governanta mobile, Chefe de Receção, multi-hotel e menus por utilizador validados');
