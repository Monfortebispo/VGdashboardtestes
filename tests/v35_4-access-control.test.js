...
assert.strictEqual(pkg.version,'35.7.0','V35.6 deve estar identificada no package');
...
assert(responsive.includes('@media (max-width:1650px)')&&responsive.includes('@media (max-width:1180px)')&&responsive.includes('overflow-x:hidden')&&responsive.includes('overflow-x:auto!important'),'V35.7 deve preservar e adaptar desktop 125%/150% sem scroll horizontal global e manter scroll local nas tabelas');
...
(async()=>{
  ...
  console.log('✓ V35.7: acessos e responsividade desktop 125%/150% validados');
