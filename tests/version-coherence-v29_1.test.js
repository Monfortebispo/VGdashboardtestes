...
assert(/const BUILD='32\.[3-9]'/.test(guard)&&guard.includes("/service-worker.js?vg="),'guard deve declarar build V32.3 ou superior e SW versionado');
...
assert(/const CACHE_NAME = 'vg-operations-shell-v32-[3-9]'/.test(sw),'SW deve usar cache V32.3 ou superior');
...
assert(/service-worker\.js\?vg=32\.[3-9]/.test(mobile)&&mobile.includes("updateViaCache:'none'"),'cliente PWA deve manter URL/versionamento do guard');
