...
assert(guard.includes("const BUILD='32.3'")&&guard.includes("/service-worker.js?vg="),'guard deve declarar build e SW versionado');
...
assert(sw.includes("const CACHE_NAME = 'vg-operations-shell-v32-3'"),'SW deve usar cache V32.3');
...
assert(mobile.includes("'/service-worker.js?vg=32.3'")&&mobile.includes("updateViaCache:'none'"),'cliente PWA deve manter URL/versionamento do guard');
