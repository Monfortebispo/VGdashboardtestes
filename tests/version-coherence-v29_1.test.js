...
assert(guard.includes("const BUILD='30.0'")&&guard.includes("/service-worker.js?vg="),'guard deve declarar build e SW versionado');
...
assert(sw.includes("const CACHE_NAME = 'vg-operations-shell-v30_3'"),'SW deve usar cache v30.3');
...
assert(mobile.includes("'/service-worker.js?vg=30.0'")&&mobile.includes("updateViaCache:'none'"),'cliente PWA deve manter URL/versionamento do guard');
