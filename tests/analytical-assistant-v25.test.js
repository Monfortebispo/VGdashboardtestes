...
assert(sw.includes('vg-operations-shell-v27')&&sw.includes('/assets/js/modules/analytical-assistant-v25.js')&&sw.includes('/assets/css/analytical-assistant-v25.css'),'PWA deve incluir o Assistente V25 no shell estático');
