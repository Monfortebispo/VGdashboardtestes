...
function hoteisCanEdit(sk){const u=hoteisCurrentUser();if(!u)return false;if(hoteisIsDirection())return true;const d=HOTEIS_XLSX[sk],want=hoteisNormName(u.hotel);return !!u.hotel&&(want===hoteisNormName(d?.nome||sk)||want===hoteisNormName(sk));}
