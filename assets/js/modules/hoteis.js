...
function hoteisCanEdit(sk){const u=hoteisCurrentUser();if(!u)return false;if(hoteisIsDirection())return true;const d=HOTEIS_XLSX[sk];return !!u.hotel&&hoteisNormName(u.hotel)===hoteisNormName(d?.nome||sk);}
