...
(function(){
  ...
  function installAssistantTop(){
    ...
    const anchor=header.querySelector('.theme-dots');if(anchor)anchor.before(b);else header.appendChild(b);
  }
