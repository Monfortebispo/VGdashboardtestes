...
function setView(v) {
  ...
  if (empty) {
    if (v === 'agenda' || v === 'compras') empty.style.display = 'none';
    empty.classList.toggle('agenda-hidden', v === 'agenda' || v === 'compras');
  }
...
// HELPERS
// ==========================================================
const fmt = (v,d=0) => v==null?'—':new Intl.NumberFormat('pt-PT',{minimumFractionDigits:d,maximumFractionDigits:d}).format(v);
